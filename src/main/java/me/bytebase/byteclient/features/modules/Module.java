package me.bytebase.byteclient.features.modules;
...
public class Module extends Feature implements Jsonable {
    ...
    public void setDisplayName(String name) {
        Module module = ByteClient.moduleManager.getModuleByDisplayName(name);
        Module originalModule = ByteClient.moduleManager.getModuleByName(name);
