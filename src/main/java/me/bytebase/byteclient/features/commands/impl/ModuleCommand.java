...
import me.bytebase.byteclient.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : ByteClient.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : ByteClient.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = ByteClient.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = ByteClient.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
